        ...
        <section id="dashboard" class="mb-12 space-y-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-gray-800/50 backdrop-blur-lg p-6 rounded-lg">
                    ...
                    <p id="new_albums" class="text-4xl font-bold text-primary-500">24</p>
                </div>
                <div class="bg-gray-800/50 backdrop-blur-lg p-6 rounded-lg">
                    <h3 class="text-xl font-semibold mb-2">Total Albums</h3>
                    <p id="total_albums" class="text-4xl font-bold text-primary-500">1,234</p>
                </div>
                <div class="bg-gray-800/50 backdrop-blur-lg p-6 rounded-lg">
                    <h3 class="text-xl font-semibold mb-2">Active Albums</h3>
                    <p id="active_albums" class="text-4xl font-bold text-primary-500">987</p>
                </div>
                <div class="bg-gray-800/50 backdrop-blur-lg p-6 rounded-lg">
                    <h3 class="text-xl font-semibold mb-2">Archived Albums</h3>
                    <p id="archived_albums" class="text-4xl font-bold text-primary-500">47</p>
                </div>
            </div>
        </section>
